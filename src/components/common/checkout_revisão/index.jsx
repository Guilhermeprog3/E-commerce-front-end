...
export default function OrderReview() {
  ...
  return (
    ...
    >
      <Paper elevation={3}>
        <Typography variant="h5" align="center" gutterBottom sx={{ color: 'white', fontWeight: 'bold',marginBottom:'1.5rem' }}>
          Revisão do Pedido
        </Typography>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', marginTop: '2rem', marginLeft: 3,marginBottom:'1rem' }}>
        <Typography variant="body2" sx={{ color: 'white' }}>
        CONFIRME SEUS DADOS DE 
        </Typography>
        <Typography variant="body2" sx={{ color: '#91EE82', marginLeft: 0.5 }}>
        ENTREGA
        </Typography>
</Box>
