      ...
      <Paper elevation={3}>
        ...
        <Box sx={{ marginLeft: { sm: '17%',lg:'1%',md:'0%' }, marginTop: { sm: '10%' } }}>
          {Array(3).fill(0).map((_, index) => (
            <Box key={index} sx={{ display: 'flex', alignItems: 'center', marginBottom: { xs: 1, md: 5,sm:5 } }}>
              <img
...
/>
              ...
              <Box sx={{ flexGrow: 1,marginBottom:'10%' }}>
                ...
                <Box 
                  sx={{ 
                    ...
                    alignItems: 'center', 
                    marginTop: 1, 
                    fontSize: { sm: '3rem', md: '1rem',lg:'1.3rem' },marginBottom:'3%' // Aumentando o tamanho geral para sm e md
                  }}
                >
                  <IconButton 
                  ...
                  >
                    <RemoveIcon fontSize="inherit" /> {/* Adicionando fontSize="inherit" para pegar o tamanho do ícone */}
                  </IconButton>
                  ...
                  <TextField
                    ...
                    inputProps={{ 
                      min: 1, 
                      style: { textAlign: 'center', color: 'white', fontSize: { sm: '2rem', md: '3rem' ,lg:'1.5rem'} } // Aumentando o tamanho da fonte no campo de texto
                    }}
                    sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', marginTop: '2rem', justifyContent: 'center',marginLeft: { sm: '-24%',lg:'-2%',md:'-2%'}, }}>
            <Typography 
              variant="body2" 
              sx={{ 
                color: 'white',
